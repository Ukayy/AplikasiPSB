                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="statuspendaftar.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data_status as $data) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit.php?id=<?= $data['nisn']; ?> " class="btn btn-warning fas fa-edit"></a>
                                                            <a href="detail.php?id=<?= $data['nisn']; ?>" class="btn btn-success fas fa-eye"></a>
                                                        </td>
                                                    </tr>
                                                <?php $i++;
                                                endforeach; ?>
